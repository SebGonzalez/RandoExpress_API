...
public class InitializeListner implements ServletContextListener {
    ...
    public final void contextInitialized(final ServletContextEvent sce) {
    	if(personneDAO.getAllPersons().size() == 0) {
    		...
    		Rando r1 = new Rando("Calanque Luminy", "Magnifique randonné dans les calanques de Marseille", "Marseille", date, "43.232230", "5.435990");
    		randoDAO.save(r1);
    		
    		Date date2 = new GregorianCalendar(2020, Calendar.MARCH, 11).getTime();
    		Rando r2 = new Rando("Randonné cool", "Magnifique randonné dans Marseille", "Marseille", date2, "43.288593", "5.370514");
    		randoDAO.save(r2);
    	}
    }
